...
This content follows and reinforces section [QSS 1.3](https://assets.press.princeton.edu/chapters/s11025.pdf) in our book. Additional resources are also linked below.
...
This section highlights important concepts from [QSS chapter 1](https://assets.press.princeton.edu/chapters/s11025.pdf).
...
1.  Create a .R script saved as "LastnameSetup1.R" (use your last name). If you use the template on Canvas, after opening in RStudio, use File -\> Save As to change to create this file name. Within the body of this file, make sure to title it and provide your name.
    1.  Set your working directory using the Session tab in RStudio.
    ...
    3.  Do the calculation 7 x 3 in your R script. Store it as an object with an informative name. Report the answer as a comment \# below the code.
...
2.  In this problem, we will just re-format what we did in the first problem in an R Markdown format. Create a .Rmd R Markdown file saved as "LastnameSetup1.Rmd." If you use the template on Canvas, after opening in RStudio, use File -\> Save As to change to create this file name. Within this file, make sure to title it and provide your name.
    ...
    2.  Create a Markdown heading \# Problem 2.2. Underneath this, create an R code chunk in which you do the calculation 7 x 3 in your R script. Store it as an object with an informative name. Report the answer in plain language below the code chunk.
...
3.  Create a compiled .html file by "knitting" the .Rmd file into a .html document. Save the file as "LastnameSetup1.html." This should happen automatically. The file will be located in the folder where the .Rmd file is also saved.
